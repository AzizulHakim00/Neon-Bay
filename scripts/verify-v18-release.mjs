...
if (pkg.version !== '1.8.0') throw new Error(`Expected package version 1.8.0, found ${pkg.version}`);
...
console.log(JSON.stringify({ release:'Neon Bay v1.8 Empire Expansion', files:requiredFiles.length, packageVersion:pkg.version, performanceHotfix:true, status:'ready' }, null, 2));
